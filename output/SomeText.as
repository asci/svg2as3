...
public var rect3024:Sprite = new Sprite();
public var center:TextField = new TextField();
public var rect3032:Sprite = new Sprite();
public var right:TextField = new TextField();
public var close:RedButton = new RedButton();
public var testInput:TextField = new TextField();
public var violBut:VioletButton = new VioletButton();
...
public var normal:Sprite = new Sprite();
public var over:Sprite = new Sprite();
public var hit:Sprite = new Sprite();
...
over.visible = false;
hit.visible = false;
addEventListener(MouseEvent.MOUSE_OVER, function (e:MouseEvent):void {over.visible = true;normal.visible = false;})
addEventListener(MouseEvent.MOUSE_OUT, function (e:MouseEvent):void {over.visible = false;hit.visible = false;normal.visible = true;})
addEventListener(MouseEvent.MOUSE_DOWN, function (e:MouseEvent):void {hit.visible = true;normal.visible = false;})
addEventListener(MouseEvent.MOUSE_UP, function (e:MouseEvent):void {hit.visible = false;over.visible = true;})
}

}
internal class VioletButton extends Sprite {
[Embed(source="image4158.png")]
private var IMAGE4158:Class;
public var normal:Bitmap = new IMAGE4158();
[Embed(source="image4112.png")]
private var IMAGE4112:Class;
public var over:Bitmap = new IMAGE4112();
[Embed(source="image4135.png")]
private var IMAGE4135:Class;
public var hit:Bitmap = new IMAGE4135();

public function VioletButton() {
addChild(normal);
addChild(over);
addChild(hit);
normal.x = 260.27774;
